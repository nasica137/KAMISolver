...
def main(algorithm, optimization):
    ...
    convert_from_txt_to_csv('run_time_%s-%s-PROBLEM22.txt' % (algorithm, optimization), 'run_time')

    convert_from_txt_to_csv('node_expansions_%s-%s-PROBLEM22.txt' % (algorithm, optimization), 'node_expansions')
